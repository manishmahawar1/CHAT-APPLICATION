                    ...
                    <div className='w-full flex flex-col md:flex-row bg-slate-900 z-10'>
                        ...
                        <div className='md:w-1/2 hidden md:flex flex-col items-center p-6 bg-gradient-to-bl from-slate-800/20 to-transparent'>
                            ...
                            <div className='mt-6 text-center'>
                                ...
                                <h3 className='text-xl font-medium text-cyan-400 italic'>connect Anytime, Anywhere</h3>

                                <div className='mt-4 flex justify-center gap-4'>
                                    <span className='px-4 py-2 text-center bg-slate-800 rounded-2xl text-cyan-400 cursor-pointer hover:text-white hover:bg-slate-700'>Secure</span>
                                    <span className='px-4 py-2 text-center bg-slate-800 rounded-2xl text-cyan-400 cursor-pointer hover:text-white hover:bg-slate-700'>Fast</span>
                                    <span className='px-4 py-2 text-center bg-slate-800 rounded-2xl text-cyan-400 cursor-pointer hover:text-white hover:bg-slate-700'>Reliable</span>
